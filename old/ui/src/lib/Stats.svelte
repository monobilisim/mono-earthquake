<script lang="ts">
	...
	const dailySuccessRate = $derived(
		currentStats.daily_successful + currentStats.daily_failed > 0
			? (currentStats.daily_successful /
					(currentStats.daily_successful + currentStats.daily_failed)) *
					100
			: 0
	);

	const weeklySuccessRate = $derived(
		currentStats.weekly_successful + currentStats.weekly_failed > 0
			? (currentStats.weekly_successful /
					(currentStats.weekly_successful + currentStats.weekly_failed)) *
					100
			: 0
	);

	const monthlySuccessRate = $derived(
		currentStats.monthly_successful + currentStats.monthly_failed > 0
			? (currentStats.monthly_successful /
					(currentStats.monthly_successful + currentStats.monthly_failed)) *
					100
			: 0
	);

	const readRate = $derived(
		currentStats.total_messages > 0
			...
			<div class="bars">
				<div class="bar-group">
					<div class="bar">
						<div
							class="bar-fill"
							style="height: {dailySuccessRate}%; background-color: {getColor(dailySuccessRate)}"
						></div>
					</div>
					<div class="bar-info">
						...
						<div class="counts">
							{currentStats.daily_successful}/{currentStats.daily_successful +
								currentStats.daily_failed}
						</div>
					</div>
				</div>
				...
				<div class="bar-group">
					<div class="bar">
						<div
							class="bar-fill"
							style="height: {weeklySuccessRate}%; background-color: {getColor(weeklySuccessRate)}"
						></div>
					</div>
					<div class="bar-info">
						...
						<div class="counts">
							{currentStats.weekly_successful}/{currentStats.weekly_successful +
								currentStats.weekly_failed}
						</div>
					</div>
				</div>
				...
				<div class="bar-group">
					<div class="bar">
						<div
							class="bar-fill"
							style="height: {monthlySuccessRate}%; background-color: {getColor(
								monthlySuccessRate
							)}"
						></div>
					</div>
					<div class="bar-info">
						...
						<div class="counts">
							{currentStats.monthly_successful}/{currentStats.monthly_successful +
								currentStats.monthly_failed}
						</div>
					</div>
				</div>
			</div>
